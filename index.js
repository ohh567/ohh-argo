...
const UUID = process.env.UUID || '68d24d90-fb29-4b30-bf60-20931a86ae31'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '[2603:c020:18:81bb:0:d670:c0cf:f556]:8008';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || 'yKiN03jHsE4KDOS0VMkNGYdM6QdAxRnc';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
